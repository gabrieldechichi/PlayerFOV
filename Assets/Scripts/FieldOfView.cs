...
public class FieldOfView : MonoBehaviour {
	...
	public float meshResolution;//Number of rays to cast per degree
	...
	void DrawFieldOfView()
	{
		...
		for (int i = 0; i < stepCount; i++) {
			...
			if (i>0)
			{
				...
				if (oldViewCast.hit != newViewCast.hit || oldViewCast.hit && newViewCast.hit && edgeDstThresholdExceeded)//Did one viewcast hit smoething and the other didn't?
				{
